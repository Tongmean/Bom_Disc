...
const SelectedOuters = async (req, res) => {
    try {
        dbconnect.query(`SELECT DISTINCT "Outer_Id" FROM "Outer" `, (err, result) => {
            if (err) {
                res.status(500).json({
                    success: false,
                    msg: "ดึงข้อมูลไม่สำเร็จ",
...
const SelectedDatasheets = async (req, res) => {
    try {
        dbconnect.query(`SELECT DISTINCT "Data_Sheet_No" FROM "Data_Sheet" `, (err, result) => {
            if (err) {
                res.status(500).json({
                    success: false,
                    msg: "ดึงข้อมูลไม่สำเร็จ",
...
const SelectedProductspecs = async (req, res) => {
    try {
        dbconnect.query(`SELECT DISTINCT "Product_Spec_Id" FROM "Product_Spec" `, (err, result) => {
            if (err) {
                res.status(500).json({
                    success: false,
                    msg: "ดึงข้อมูลไม่สำเร็จ",
...
const Selectedadditionalpackages = async (req, res) => {
    try {
        dbconnect.query(`SELECT DISTINCT "Additional_Package_Id" FROM "Additional_Package" `, (err, result) => {
            if (err) {
                res.status(500).json({
                    success: false,
                    msg: "ดึงข้อมูลไม่สำเร็จ",
...
const Selectedshims = async (req, res) => {
    try {
        dbconnect.query(`SELECT DISTINCT "Compact_No_Modify" FROM "Shim" `, (err, result) => {
            if (err) {
                res.status(500).json({
                    success: false,
                    msg: "ดึงข้อมูลไม่สำเร็จ",
...
const Selecteddrawing = async (req, res) => {
    try {
        dbconnect.query(`SELECT DISTINCT "Compact_No_Modify_Drawing" FROM "Drawing" `, (err, result) => {
            if (err) {
                res.status(500).json({
                    success: false,
                    msg: "ดึงข้อมูลไม่สำเร็จ",
...
const SelectedmaterialWd = async (req, res) => {
    try {
        dbconnect.query(`SELECT DISTINCT id, "Type1", "Type2", "Type3", "ID" FROM "Material" WHERE "Type2" IN ('WD', 'FP')`, (err, result) => {
            if (err) {
                res.status(500).json({
                    success: false,
                    msg: "ดึงข้อมูลไม่สำเร็จ",
