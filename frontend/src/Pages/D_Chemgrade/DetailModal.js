...
const DetailModal = ({ show, onHide, data, Tablename, historyLog }) => {
    ...
    const columnNameLabels = {
        No: 'ลำดับ',
        Chem_Grade_Code: 'เกรดเคมี',
        SG_Value: 'ค่าความถ่วงจำเพาะ (SG Value)',
        Pressure_Cold: 'แรงดันพิมพ์เย็น',
        Pressure_Hot: 'แรงดันพิมพ์ร้อน ',
        Temp_Above: 'อุณหภูมิสูงสุด',
        Temp_Bellow: 'อุณหภูมิต่ำสุด',
        Total_Time: 'เวลารวม (Total Time)',
