...
const DetailModal = ({ show, onHide, data, Tablename, historyLog }) => {
    ...
    const columnNameLabels = {
        ...
        Type_Mold: 'ประเภท',
        Area: 'สถานที่จัดเก็บ',
        Full_Hole_Quantity: 'จำนวนชิ้นเต็ม',
        Hole_Deformation_Quantity: 'จำนวนชิ้นเสีย',
        Hole_Balance_Quantity: 'จำนวนชิ้นคงเหลือ',
        Hole_Active_Quantity: 'จำนวนชิ้น Active',
        Hole_Deformation_Position: 'ตำแหน่งชิ้นที่เสีย',
        CreateBy: 'กรอกโดย',
        CreateAt: 'กรอกเมื่อ',
