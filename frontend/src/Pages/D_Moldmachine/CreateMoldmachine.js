...
import { createD_Mold_Machine } from '../../Ultility/D_Mold_Machine';
...
const CreateMoldmachine = () => {
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            const result = await createD_Mold_Machine(Data);
    ...
    return (
        <div className="container-fluid">
            <h2>แบบฟอร์มบันทึกข้อมูล Mold-Machine</h2>
            <Form
...
export default CreateMoldmachine;
