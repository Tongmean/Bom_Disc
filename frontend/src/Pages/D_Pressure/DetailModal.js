...
const DetailModal = ({ show, onHide, data, Tablename, historyLog }) => {
    ...
    const columnNameLabels = {
        No:'ลำดับ',
        Data_Sheet_No_Pressure: 'Data Sheet No. (แรงดัน)',
        Data_Sheet_No: 'Data Sheet No. (น้ำหนัก).',

        Mold_Machine_Cold_Code: 'Mold-Machine-พิมพ์เย็น',
        Pcs_Per_Mold_Cold: 'ชิ้นต่อพิมพ์ (พิมพ์เย็น)',
        Presure_Cold: 'แรงดันต่อเครื่อง (พิมพ์เย็น)',

        Mold_Machine_Cold_Hot: 'Mold-Machine-พิมพ์ร้อน',
        Pcs_Per_Mold_Hot: 'ชิ้นต่อพิมพ์ (พิมพ์ร้อน)',
        Presure_Hot: 'แรงดันต่อเครื่อง (พิมพ์ร้อน)',
