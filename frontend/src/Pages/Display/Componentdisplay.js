...
import { fetchDisplayComponent } from '../../Ultility/Displayapi';
import ExcelExportButton from '../../Components/ExcelExportButton';
import ClipboardButton from '../../Components/ClipboardButton';
import { baseURLproductspec,baseURLdrawing, baseURLshim, baseURLMaterial, baseURLpackage } from '../../Ultility/ApiSetup/api';
...
const Componentdisplay = () => {
  ...
  const columnDefs = [
    ...
    { headerName: 'กล่อง (Inner)', field: 'Rm_Pk_Id' },
    { headerName: 'ชิม', field: 'Compact_No_Modify' },
    {
        headerName: 'Actions',
        field: 'actions',
        pinned: 'right',
        cellRenderer: (params) => (
            <div>
                <>
                    ...
                    {params.data.shimfile && (
                        <a
                            href={`${baseURLshim}/${encodeURIComponent(params.data.shimfile)}`}
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <button
                    ...
                    {params.data.innerboxfile && (
                        <a
                            href={`${baseURLpackage}/${encodeURIComponent(params.data.innerboxfile)}`}
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <button
  ...
  useEffect(() => {
    const load = async () => {
      try {
        const packageData = (await fetchDisplayComponent()).data;
