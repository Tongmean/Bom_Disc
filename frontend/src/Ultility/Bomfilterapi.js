...
export const fetchBomfilter = async () => {
  try {
    const response = await apiClient.get('/bomfilter'); // Send the GET request to the server
...
export const fetchBomfilterbycodefg = async (Code_Fg) => {
  try {
    const response = await apiClient.post(`/bomfilter`, Code_Fg); // Send the GET request to the server
