...
export const fetchMaterials = async () => {
  try {
    const response = await apiClient.get('/material'); // Send the GET request to the server
...
export const fetchMaterial = async (id) => {
  try {
    const response = await apiClient.get(`/material/${id}`); // Send the GET request to the server
...
export const fetchHistoryLog = async (id) => {
  try {
    const response = await apiClient.get(`/historylog/material/${id}`); // Send the GET request to the server
